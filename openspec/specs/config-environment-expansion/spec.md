# config-environment-expansion Specification

## Purpose

TBD - created by archiving change 'add-config-environment-expansion'. Update Purpose after archive.
...
<!-- @trace
source: add-config-environment-expansion
updated: 2026-08-26
code:
  - mkdocs.yml
