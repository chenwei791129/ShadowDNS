...
| shutdown (after reload-goroutine join) | already unmapped, or reclaimed by the OS at exit | reclaimed once unreachable, no later than the OS reclaiming it at exit | closed explicitly (idempotent) |
