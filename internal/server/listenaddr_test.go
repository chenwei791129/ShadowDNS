...
func TestResolveListenAddresses_OverrideBranch(t *testing.T) {
	...
	got, err := ResolveListenAddresses("127.0.0.1:5353", []string{"any"}, silentLogger())
	if err != nil {
...
func TestResolveListenAddresses_OverrideIgnoresListenOn(t *testing.T) {
	...
	got, err := ResolveListenAddresses("10.9.9.9:53", []string{"192.168.0.1", "192.168.0.2"}, silentLogger())
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
...
func TestResolveListenAddresses_ListenOnBranch(t *testing.T) {
	...
	got, err := ResolveListenAddresses(":53", []string{"10.0.0.1", "192.168.1.1"}, silentLogger())
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
...
func TestResolveListenAddresses_ListenOnInheritsPortFromListenFlag(t *testing.T) {
	...
	got, err := ResolveListenAddresses(":5353", []string{"10.0.0.1"}, silentLogger())
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
...
func TestResolveListenAddresses_FallbackAnyBranch(t *testing.T) {
	...
	got, err := ResolveListenAddresses(":53", nil, silentLogger())
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
...
func TestResolveListenAddresses_AnyTokenExpands(t *testing.T) {
	...
	got, err := ResolveListenAddresses(":53", []string{"any"}, silentLogger())
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
	slices.Sort(got)
...
func TestResolveListenAddresses_NoneTokenAlone_Fatal(t *testing.T) {
	...
	_, err := ResolveListenAddresses(":53", []string{"none"}, silentLogger())
	if err == nil {
...
func TestResolveListenAddresses_NoneWithAny_NoneIsSkipped(t *testing.T) {
	...
	got, err := ResolveListenAddresses(":53", []string{"any", "none"}, silentLogger())
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
...
func TestResolveListenAddresses_UnsupportedTokenWarnedAndSkipped(t *testing.T) {
	...
	got, err := ResolveListenAddresses(":53", []string{"!10.0.0.99", "any"}, logger)
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
...
func TestResolveListenAddresses_IPv6LiteralTokenSkipped(t *testing.T) {
	// Raw IPv6 literals in listen-on are out of scope for this change.
	logger, buf := newTestLogger()
	withIfaceAddrs(t, []net.Addr{mkIPNet(t, "10.0.0.1/24")})

	got, err := ResolveListenAddresses(":53", []string{"::1", "10.0.0.1"}, logger)
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
	want := []string{"10.0.0.1:53"}
...
func TestResolveListenAddresses_Deduplicates(t *testing.T) {
	...
	got, err := ResolveListenAddresses(":53", []string{"10.0.0.1", "10.0.0.1"}, silentLogger())
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
	want := []string{"10.0.0.1:53"}
...
func TestResolveListenAddresses_AllTokensUnsupported_Fatal(t *testing.T) {
	...
	_, err := ResolveListenAddresses(":53", []string{"!10.0.0.1", "::1"}, silentLogger())
	if err == nil {
...
func TestResolveListenAddresses_MalformedListenFlag(t *testing.T) {
	...
	_, err := ResolveListenAddresses("not a host port", nil, silentLogger())
	if err == nil {
